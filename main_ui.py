...
from progressbar import ExtendProgressBar
...
"}")
        icon2 = QIcon()
        icon2.addFile(u"icon/\u8bbe\u7f6e.png", QSize(), QIcon.Normal, QIcon.Off)
...
"background-color: white}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"VisualData APP-UI 中国大气CO2浓度时空分布特征及典型地区驱动因子分析", None))
